...
def test_scenario_positive_1():
    ...
    time.sleep(3)
    driver.close()
    print("\nPositive scenario with form filling is completed\n")




#python -m pytest -s -v SS_SDET_tempProj/test_scenario_positive.py
#python -m pytest -s -v SS_SDET_tempProj/

#Run with allure report
#python -m pytest SS_SDET_tempProj/test_scenario_positive.py --alluredir="SS_SDET_tempProj/allure_results"
#python -m pytest SS_SDET_tempProj/ --alluredir="SS_SDET_tempProj/allure_results"
